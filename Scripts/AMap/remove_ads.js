...
引用地址 https://kelee.one/Resource/JavaScript/Amap/Amap_remove_ads.js
*/
...
} else if (url.includes('/c3frontend/af-ai-search/search')) {
  // #region JY-Mar新增
  // AI搜索
  if (obj?.data?.modules?.quickLink?.data?.list?.length > 0) {
